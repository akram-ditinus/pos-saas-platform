                    ...
                    <div
                        ...
                        <x-base.breadcrumb class="hidden flex-1 xl:block">
                            <x-base.breadcrumb.link
                                :index="0"
                                to="/"
                            >App</x-base.breadcrumb.link>
                            <x-base.breadcrumb.link
                                :index="1"
                                to="/"
                            >Dashboards</x-base.breadcrumb.link>
                            <x-base.breadcrumb.link
                                :index="2"
                                to="/"
                                :active="true"
                        ...
                        <div class="flex flex-1 items-center">
                            <div class="ml-auto flex items-center gap-1">
                                ...
                                <!-- <a class="rounded-full p-2 hover:bg-slate-200/50 group-[.top-bar--active]:hover:bg-slate-50" href="">
                                                          <x-base.lucide class="h-[18px] w-[18px]" icon="Moon"/>
                                                        </a> -->
                                <a
