...
@section('subcontent')
    <div class="grid grid-cols-12 gap-x-6 gap-y-10">
        <div class="col-span-12 sm:col-span-10 sm:col-start-2">
            ...
            <div class="mt-7">
                <form method="POST" action="{{route('super.admin.taxes.update',$tax['uid'])}}">
                    @csrf
                    @method('patch')
                    <div class="box box--stacked flex flex-col">
                        <div class="p-7">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <div class="flex flex-col items-center md:flex-row">
                                        <x-base.form-input
                                            ...
                                            type="text" name="title" value="{{ old('title',$tax['title'])}}" />
                            ...
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <x-base.form-input type="number" value="{{ old('percentage',$tax['percentage']) }}" name='percentage' />
                                    @error('percentage')
                                        <x-base.alert class="mb-2 flex items-center" variant="outline-danger">
                                            {{ $message }}
                                            <x-base.alert.dismiss-button class="btn-close" type="button" aria-label="Close">
                            ...
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <x-base.form-select name="status">
                                        <option @if($tax['status']=='active') selected @endif value="active"> Active</option>
                                        <option @if($tax['status']=='inactive') selected @endif value="inactive"> Inactive</option>
