                    ...
                    <div class="box box--stacked flex flex-col">
                        <div class="p-7">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <div class="flex flex-col items-center md:flex-row">
                                        <x-base.form-select name="tax_id">
                                            ...
                                            <option value="{{$tax->uid}}">{{$tax->title}}</option>
                                            @endforeach
                                        </x-base.form-select>
                                    </div>
                                </div>
                            ...
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <div class="flex flex-col items-center md:flex-row">
                                        <x-base.form-textarea name="description" >{{ old('description')}}</x-base.form-textarea>
                                    </div>
                                    @error('description')
                                        <x-base.alert class="mb-2 flex items-center" variant="outline-danger">
                                            {{ $message }}
                            ...
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <x-base.form-input type="number" value="{{ old('price',0) }}" name='price' />
                                    @error('price')
                                        <x-base.alert class="mb-2 flex items-center" variant="outline-danger">
                                            {{ $message }}
                                            <x-base.alert.dismiss-button class="btn-close" type="button" aria-label="Close">
                            ...
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <x-base.form-input type="number" value="{{ old('sale_price',0) }}" name='sale_price' />
                                    @error('sale_price')
                                <x-base.alert class="mb-2 flex items-center" variant="outline-danger">
                                    {{ $message }}
                                    <x-base.alert.dismiss-button class="btn-close" type="button" aria-label="Close">
                            ...
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <x-base.form-input type="number" value="{{ old('duration_in_days',1) }}" name='duration_in_days' />
                            ...
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <x-base.form-input type="number" value="{{ old('trial_period_in_days',0) }}" name='trial_period_in_days' />
                            ...
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <x-base.form-input type="text" value="{{ old('remarks') }}" name='remarks' />
                                @error('remarks')
                                <x-base.alert class="mb-2 flex items-center" variant="outline-danger">
                                    {{ $message }}
                                    <x-base.alert.dismiss-button class="btn-close" type="button" aria-label="Close">
