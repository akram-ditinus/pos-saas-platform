            ...
            <div class="relative z-10 flex h-full w-full flex-col justify-center py-2 lg:py-32">
                ...
                <div class="mt-10">
                    ...
                    <div class="mt-2.5 text-slate-600">
                        ...
                        <a class="font-medium text-primary"  href="{{route('signup')}}">
                            Sign In
                        </a>
                    </div>
                    ...
                    @enderror
                        ...
                        />
                        @error('email')
                        <div class="alert relative border rounded-md px-5 py-4 bg-danger border-danger text-white dark:border-danger mb-2 flex items-center">{{ $message }}</div>
                    @enderror
                    ...
                    @enderror
                        ...
                        <div class="mt-5 text-center xl:mt-8 xl:text-left">
                           <x-base.button class="w-full bg-gradient-to-r from-theme-1/70 to-theme-2/70 py-3.5 xl:mr-3" variant="primary" rounded> 
                                Sign Up
                            </x-base.button>
                        </form>
                            <a href="{{route('login')}}" class="mt-3 transition duration-200 border shadow-sm inline-flex items-center justify-center px-3 font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&:hover:not(:disabled)]:bg-opacity-90 [&:hover:not(:disabled)]:border-opacity-90 [&:not(button)]:text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:border-darkmode-100/40 dark:text-slate-300 [&:hover:not(:disabled)]:bg-secondary/20 [&:hover:not(:disabled)]:dark:bg-darkmode-100/10 rounded-full mt-3 w-full bg-white/70 py-3.5">
                                Sign In
                        </a>
                        </div>
                    </div>
