...
@section('content')
    <div @class([
        'background relative group background overflow-x-hidden scroll-smooth',
        ...
        <div class="container relative z-10 pt-40">
            <div class="mb-40 flex flex-col items-center gap-56">
                <div class="flex flex-col items-center">
                    ...
                    <a href="/">
                        <x-base.button
                            class="mt-8 border-white/10 bg-white/10 px-7 py-3 text-[0.94rem] text-white group-[.background--hidden]:border-primary group-[.background--hidden]:bg-primary"
                            rounded
                        >
                            View Demo
                        </x-base.button>
                    </a>
                    <div class="mt-36 grid w-full grid-cols-3 gap-5 px-20">
                        ...
                        <div class="mt-2">
                            <div class="box box--stacked border-theme-1/50 p-1">
                                <div class="rounded-lg bg-gradient-to-b from-theme-1/90 to-theme-2/90 p-4">
                                    ...
                                    <div class="my-5 flex flex-col gap-2.5 border-y border-dashed border-white/20 py-5">
                                    ...
                                    @foreach (['default', 'theme-1', 'theme-2', 'theme-3', 'theme-4', 'theme-5', 'theme-6', 'theme-7', 'theme-8', 'theme-9', 'theme-10', 'theme-11', 'theme-12', 'theme-13', 'theme-14', 'theme-15', 'theme-16', 'theme-17'] as $colorKey => $colorScheme)
                                        <x-base.tippy
                                            ...
                                            @class([
                                                ...
                                                'border-theme-1/60' => $activeColorScheme == $colorScheme,
                                            ])
                ...
                >
                    ...
                    <div class="mt-10 grid w-full grid-cols-3 gap-x-5 gap-y-8 px-20">
                        <div class="box box--stacked flex flex-col items-center p-5">
                            <div class="h-12 w-12">
                                <img src="{{ Vite::asset('resources/images/frameworks/react.png') }}" />
                            </div>
                            <div class="mt-4 text-base font-medium">React 18+</div>
                        ...
                        <div class="box box--stacked flex flex-col items-center p-5">
                            <div class="h-12 w-12">
                                <img src="{{ Vite::asset('resources/images/frameworks/headlessui.png') }}" />
                            </div>
                            <div class="mt-4 text-base font-medium">Headless UI</div>
                            <div class="mt-2 pb-2 text-center leading-relaxed text-slate-500">
                        ...
                        <div class="box box--stacked flex flex-col items-center p-5">
                            <div class="h-12 w-12">
                                <img src="{{ Vite::asset('resources/images/frameworks/reduxtoolkit.png') }}" />
                            </div>
                            <div class="mt-4 text-base font-medium">Redux Toolkit</div>
                            <div class="mt-2 pb-2 text-center leading-relaxed text-slate-500">
                        ...
                        <div class="box box--stacked flex flex-col items-center p-5">
                            <div class="h-12 w-12">
                                <img src="{{ Vite::asset('resources/images/frameworks/typescript.png') }}" />
                            </div>
                            <div class="mt-4 text-base font-medium">Typescript</div>
                            <div class="mt-2 pb-2 text-center leading-relaxed text-slate-500">
                    ...
                    <div class="mt-10 flex w-full gap-7 px-24">
                        <div class="box box--stacked flex w-full">
                            ...
                            <div class="flex w-72 flex-none flex-col border-l border-dashed p-5">
                                ...
                                <div class="text-center text-2xl font-medium">$25</div>
                                <x-base.button
                                    class="mt-5"
                                    href="https://themeforest.net/item/tailwise-intuitive-tailwind-dashboard-kit/48659596"
                                    as="a"
