                ...
                <div class="relative col-span-12 flex flex-col gap-y-7 lg:col-span-9 xl:col-span-8">
                    <div class="box box--stacked flex flex-col p-5">
                        <div class="rounded-[0.6rem] border border-slate-200/60 p-5 dark:border-darkmode-400">
                            ...
                            <div class="mt-5">
                                <x-base.alert
                                    class="mb-2 flex items-center border-warning/30 bg-warning/5 px-4"
                        ...
                        <div class="rounded-[0.6rem] border border-slate-200/80 p-5 dark:border-darkmode-400">
                            ...
                            <div class="mt-5">
                                <div
                                    ...
                                    <div class="mt-3 w-full flex-1 xl:mt-0">
                                        <div class="rounded-md border border-dashed border-slate-300/80">
                                            <div class="grid grid-cols-9 gap-5 px-5 pt-5 sm:grid-cols-10">
                                                @foreach ($products->take(5) as $fakerKey => $faker)
                                                    <div
                                                        class="image-fit zoom-in relative col-span-3 h-24 cursor-pointer md:col-span-2">
                                                        <img
                                                            class="rounded-lg"
                                                        ...
                                                        />
                                                        <x-base.tippy
                                                            class="absolute right-0 top-0 -mr-2 -mt-2 h-5 w-5 rounded-full bg-white"
                                                            content="Remove this image?"
                                                        >
                                                            <div
                                                                class="flex h-full w-full items-center justify-center rounded-full border border-danger/50 bg-danger/80 text-white">
                                                                <x-base.lucide
                        ...
                        <div class="rounded-[0.6rem] border border-slate-200/60 p-5 dark:border-darkmode-400">
                            ...
                            <div class="mt-5">
                                <div
                                    ...
                                    <div class="mt-3 w-full flex-1 xl:mt-0">
                                        <div
                                            class="relative rounded-md border border-slate-200/80 bg-slate-50/80 py-10 pl-5 pr-5 dark:border dark:bg-transparent xl:pr-10">
                                            <a
                                            ...
                                            <div>
                                                ...
                                                <x-base.form-inline class="mt-5 items-start first:mt-0">
                                ...
                                <div
                                    class="mt-2 block flex-col pt-2 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                    <label class="mb-2 inline-block sm:mb-0 sm:mr-5 sm:text-right xl:mr-14 xl:w-60">
                                        <div class="text-left">
                                            <div class="flex items-center">
                                ...
                                <div class="mt-2 pt-2 first:mt-0 first:pt-0 xl:ml-60 xl:pl-14">
                                    <x-base.button
                                        class="w-full border-slate-200/80 bg-slate-50/80 py-3"
                            ...
                            <div class="mt-5">
                                <div
                                    ...
                                    <div class="mt-3 w-full flex-1 xl:mt-0">
                                        ...
                                        <x-base.alert
                                            class="mb-2 mt-5 flex items-center border-primary/20 bg-primary/5 px-4"
                                            variant="outline-primary"
                                        >
                                            <x-base.lucide
                    ...
                    <div class="mt-1 flex flex-col justify-end gap-3 md:flex-row">
                        <x-base.button
