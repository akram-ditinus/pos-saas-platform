                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <x-base.form-select name="currency">
                                        @foreach($currencies as $currency)
                                            <option value="{{$currency->uid}}" @if($restaurant['currency']==$currency->uid)  @endif> {{$currency->title}}</option>
                                        @endforeach
                                    </x-base.form-select>
                                </div>
                            </div>
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <x-base.form-select class="w-full" data-placeholder="Select your country"
                                        ...
                                        @foreach ($countries as $key => $country)
                                            <option value="{{ $country['dial_code'] }}" @if($restaurant['pincode']==$country['dial_code']) selected @endif>
                                                {{ $country['name'] }}
                                            </option>
                                        @endforeach
                                    </x-base.form-select>
