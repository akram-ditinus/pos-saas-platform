        ...
        <div
            ...
            <div
                ...
                <div class="w-2/3 mt-3 leading-relaxed text-center text-slate-500">
                    ...
                    <span class="italic font-medium global-search__keyword"></span>
                ...
                <div class="px-5 py-4 border-t border-dashed">
                    ...
                    <div class="mt-3.5 flex flex-col gap-1">
                        @foreach ($users->take(3) as $fakerKey => $faker)
                            ...
                            >
                                <div
                                    class="w-6 h-6 overflow-hidden border-2 rounded-full image-fit zoom-in box border-slate-200/70">
                                    <img
                ...
                <div class="px-5 py-4 border-t border-dashed">
                    ...
                    <div class="mt-3.5 flex flex-col gap-1">
                        @foreach ($departments->take(3) as $fakerKey => $faker)
                            ...
                            >
                                <div
                                    class="flex items-center justify-center w-6 h-6 overflow-hidden border rounded-md zoom-in box border-theme-1/10 bg-theme-1/10">
                                    @if (mt_rand(0, 1))
                                        <x-base.lucide
